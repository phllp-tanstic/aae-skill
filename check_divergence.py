...
def run_divergence_check(top_n=5):
    ...
    for n in top:
        ...
        results.append({
            ...
            "market_cap_change_24h": n.get("market_cap_change_24h", 0),
            "relative_attention_alpha": n.get("relative_attention_alpha", 0),
            "market_volume_change": n.get("market_volume_change", 0),
            "signal": signal,
